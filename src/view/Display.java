...
public interface Display {
     ...
     */
    int showConfirm(String title, String content);
     ...
     */
    String showInput(String title, String content, boolean invalid);
     ...
     */
    int showOptions(String title, String content, String[] options);
}